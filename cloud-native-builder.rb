...
echo "docker run -e DATABASE_URL='nulldb://nohost' -e RAILS_ENV=$APP_ENV \\
  -e RAILS_LOG_TO_STDOUT=true -p $APP_PORT:$APP_PORT -it $APP_NAME"
# -e HOST=$APP_HOST -e PORT=$APP_PORT \\ 
